...
import ProfileImg from '../../public/Rithas2003.jpg' // Change Image name to your Uploaded File Name
            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                       ...
                       I am Ritha.I am second year s3 student at Govt engineering college Thrissur. I am a tech enthusiast and I like to organize and manage things.
                        <br/><br/>
                        {/* Add Your Tech Stacks */}
                        Tech Stacks : C,java,ui/ux
                    </p>
                </div>
            </div>
