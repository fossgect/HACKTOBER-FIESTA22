...
import ProfileImg from '../../public/AditiAjithkumar.jpg' // Change Image name to your Uploaded File Name
...
export default function EntryComponent(){
    ...
    const [txt,setTxt] = useState("Hey I'm Aditi Ajithkumar.") // Change X to Your Full Name
            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                        ...
                        CSE Undergrad. Passionate in learning new stuffs and loves solving puzzles.
                        <br/><br/>
            ...
            <div className="w-full pb-8">
                ...
                <div className="grid grid-cols-1 justify-center gap-6 mt-8 lg:grid-cols-2 xl:grid-cols-3">
                    ...
                    <Grid sm={12} md={5} className="flex justify-center">
                        ...
                        <Card.Body css={{ py: "$10" }}>
                            <Text>
                                Created a basic snake game using pygame module in python. The aim of the game is to feed the snake and earn points.
                            </Text>
                        </Card.Body>
                        <Card.Divider />
                        <Card.Footer>
                            <Row justify="flex-end">
                                <Link href="https://github.com/AditiAjithkumar/Snake-Game">
