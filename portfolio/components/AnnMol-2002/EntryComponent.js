...
import ProfileImg from '../../public/AnnMol-2002.jpg' // Change Image name to your Uploaded File Name
...
export default function EntryComponent(){
    ...
    const [txt,setTxt] = useState("Hey I'm Ann Mol") // Change X to Your Full Name
            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                        ...
                        I'm a 3rd year CSE undergraduate, studying at Government Engineering College, Thrissur. I'm interested in Machine learning.
                        I also like problem solving. I like to sing and like listening to music during my free times.
                        <br/><br/>
                        {/* Add Your Tech Stacks */}
                        Tech Stacks : ML, C programming, Java 
                    </p>
                </div>
            </div>
                    ...
                    <Grid sm={12} md={5} className="flex justify-center">
                        ...
                        <Card.Footer>
                            <Row justify="flex-end">
                                <Link href="https://github.com/AnnMol-2002/Sudoku_game">
