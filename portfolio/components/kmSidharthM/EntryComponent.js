            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                        ...
                        I am a 3rd year undergradute in Computer Science Engineering.I am mainly skilled at C++ and Python.
                        I also have experience in Flutter, Java, AR filter making and C.
                        <br/><br/>
                        {/* Add Your Tech Stacks */}
                        Tech Stacks : Python,C++,C,Flutter,Java,Spark AR
                    </p>
                </div>
            </div>
