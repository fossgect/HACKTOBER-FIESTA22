...
import ProfileImg from '../../public/nived.jpeg' // Change Image name to your Uploaded File Name
...
export default function EntryComponent(){
    ...
    const [txt,setTxt] = useState("Hey I'm Nived Rockstar") // Change X to Your Full Name
            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                        ...
                        I am the coolest man you'll ever meet. My name is Nived Krishna.<br/><br/>
            ...
            <div className="w-full pb-8">
                ...
                <div className="grid grid-cols-1 justify-center gap-6 mt-8 lg:grid-cols-2 xl:grid-cols-3">
                    ...
                    <Grid sm={12} md={5} className="flex justify-center">
                        ...
                        <Card.Body css={{ py: "$10" }}>
                            <Text>
                                great project created by the greatest of all time
                                .
                                .
                                .
                                . 
                        ...
                        <Card.Footer>
                            <Row justify="flex-end">
                                <Link href="https://github.com/nived-krish44/HACKTOBER-FIESTA22/blob/main/pygame/gameit/nived_krish44.py">
                                    <Button size="sm" light color="primary">Link</Button>
                                </Link>
                            </Row>
                        </Card.Footer>
