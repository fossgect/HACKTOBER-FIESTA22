...
import ProfileImg from '../../public/unniznd.jpg' // Change Image name to your Uploaded File Name
...
export default function EntryComponent(){
    ...
    const [txt,setTxt] = useState("Hey I'm Aanand S") // Change X to Your Full Name
            ...
            <div className="w-full flex flex-col items-center py-16 px-8">
                ...
                <div className="description mt-6">
                    ...
                    <p className="text-center font-txt mt-3 max-w-[600px]">
                        ...
                        Software Dev | Web3 | Blockchain | Tech Enthusiast
                        {/* Add Your Tech Stacks */}
                        Tech Stacks : Django, Blockchain, Web3, Python, Java
                    </p>
                </div>
            </div>
