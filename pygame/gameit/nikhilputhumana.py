...
# Users can guess a random number between 1 and 100.
# In the first level, the game has 10 chances
# and for each chance missed, the points will be decremented by 10.
# The second level consist of 5 guesses 
# and points decrements by 20 for each wrong guess.
