...
def racing_game():
    ...
    # set window title
    pygame.display.set_caption("Vishakh's car game")
    ...
    # load player vehicle
    car = pygame.image.load("gameit/static/vishakh/car.png")
    #resize image
    ...
    # load enemy vehicle
    car2 = pygame.image.load("gameit/static/vishakh/otherCar.png")
